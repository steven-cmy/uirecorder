...
function initConfig(options){
    ...
    webdriver['goog:chromeOptions'] = webdriver['goog:chromeOptions'] || { w3c: false, args: ['--enable-automation', '--incognito'] };
    webdriver['ms:edgeOptions'] = webdriver['ms:edgeOptions'] || { w3c: false, args: ['--enable-automation', '--incognito'] };
    // webdriver['moz:firefoxOptions'] = webdriver['moz:firefoxOptions'] || { args: ['-headless'] };
    if(!mobile){
        ...
        webdriver.browsers = webdriver.browsers || 'chrome, edge';
    }
    var questions = [];
    if(mobile){
        questions = [
